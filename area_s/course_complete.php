...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <title> Complete Course |  <?php echo $brand_name; ?> </title>
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="container page__container page-section pb-0">
                 ...
                 <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-50">
                            ...
                            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                                <h2 class="mb-0">Complete Course</h2>

                                <ol class="breadcrumb p-0 m-0">
                                    <li class="breadcrumb-item"><a href="./">Courses</a></li>

                                    <li class="breadcrumb-item active"> Complete Courses </li>
                ...
                <div class="container page__container page-section">
                    ...
                    <div class="page-separator">
                        <div class="page-separator__text">Complete Course Details</div>
                    </div>
                    ...
                    <div class="table_container">
                          ...
                          <table id="courseTable" class="display responsive nowrap table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <?php 
                                  $i=0;
                                  $sql=mysqli_query($con,"select * from course_book where userid='$_SESSION[userid]' and status='CLOSE' order by id desc");
