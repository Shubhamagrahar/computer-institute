...
$branch_details = mysqli_fetch_array(mysqli_query($con, "select * from user where id='$branch_id' and status = 1"));
      ...
      <div class="col-md-3">
        <div class="card card-success" style="height:80vh; overflow-y:auto;">
          ...
          <div class="card-body p-0">
           ...
           <?php
        ?>
        <li class="list-group-item contact-item d-flex align-items-center" data-id="<?php echo $branch_id; ?>">
          <img src="<?php echo $web_link.$branch_details['photo']; ?>" 
               style="height:35px; width:35px; border-radius:50%; margin-right:10px;">
          <span><?php echo $branch_details['name']; ?></span>
...
<div class="col-md-12 text-center">
    <a href="./"><button class="btn btn-success btn-lg"><i class="fa fa-home"></i>&nbsp;&nbsp;Home</button></a>
</div>
