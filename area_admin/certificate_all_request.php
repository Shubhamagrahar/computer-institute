...
if(isset($_GET['cancel'])){
    ...
    if(!$id == ""){
        ...
        if($check == 1){
            ...
            if($update){
                echo '<script>alert("The selected enrollment request has been successfully cancelled.");window.location.assign("certificate_all_request");</script>';
            } else {
                echo '<script>alert("A server error occurred. Please try again later.");window.location.assign("certificate_all_request");</script>';   
            }
        } else {
            echo '<script>alert("Invalid request. Please select a valid enrollment to cancel.");window.location.assign("certificate_all_request");</script>';  
        }
    } else {
        echo '<script>alert("Invalid ID provided.");window.location.assign("certificate_all_request");</script>';
    }
}
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              if($row['status']=="OPEN"){
                                                   ?>
                                                   <a  href="certificate_all_request?cancel=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to cancel this request?')" title="Process" style="color:red;"><i class="fa fa-close"> Cancel</i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                   <?php
                                                }else{
