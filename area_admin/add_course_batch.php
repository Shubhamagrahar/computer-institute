...
if(sub_menu_check("F","A",$_SESSION['userid'], $type)==1){
...
if(isset($_POST['Create'])){
  ...
  if(!$batch_name==""){
     $check=mysqli_num_rows(mysqli_query($con,"select * from batch_details where batch_name='$batch_name' and branch_id='$current_branch_id'"));
     if(!$check>0){
         $insert=mysqli_query($con,"insert into `batch_details`(`batch_name`, `branch_id`) values('$batch_name', '$current_branch_id')"); 
        if($insert){
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $i=0;
                                             $sql_course=mysqli_query($con,"select * from batch_details where branch_id='$current_branch_id' order by id desc");
