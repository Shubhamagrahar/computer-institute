    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
           ...
           $show="";
            ...
            if($show==1){
            $total_enquery=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and enquiry_date='$select_date' and session_id='$c_session'"));
            $total_enquery_convert=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and enquiry_date='$select_date' and session_id='$c_session' and  status='CLOSE'"));
            $total_enquery_cancel=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and enquiry_date='$select_date' and session_id='$c_session' and status='CANCEL'"));
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                              ...
                                              $sql_d=mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and enquiry_date='$select_date' and session_id='$c_session' order by id desc");   
