...
if(isset($_POST['update_logo'])){
    $photo = $_FILES["ins_logo"]["name"];
     $photo2 = $_FILES["ins_logo"]["tmp_name"];
      if(!$photo==""){ 
            $extension12 = explode(".", $photo);
            ...
            $upload_photo= move_uploaded_file($photo2,"user_img/".$newfilename1) ;
        if($upload_photo){
            $update_dr=mysqli_query($con,"update user set ins_logo='$photo_dr' where id='$_SESSION[userid]'");
            if($update_dr){
                
                $last_check=end(explode("/",$login_details['ins_logo']));
                ...
                if($unlink_p){
                echo '<script>alert("Institute Logo Update Successfully Done.");window.location.assign("profile");</script>';
                }else{
                   echo '<script>alert("Institute Logo Unlink Failed.");window.location.assign("profile");</script>';  
                }
            }else{
                echo '<script>alert("Institute Logo Update Failed in DB.");window.location.assign("profile");</script>';     
            }
        }else{
          echo '<script>alert("Institute Logo Upload Failed.");window.location.assign("profile");</script>';     
        }
     }else{
        echo '<script>alert("Please Select Institute Logo.");window.location.assign("profile");</script>';
     }
}

if(isset($_POST['update_signature'])){
    $photo = $_FILES["sign"]["name"];
    $photo2 = $_FILES["sign"]["tmp_name"];
    ...
    if(!$photo==""){ 
        ...
        if($upload_photo){
            $update_dr = mysqli_query($con,"UPDATE user SET sign='$photo_dr' WHERE id='$_SESSION[userid]'");
            
            if($update_dr){
                $last_check = end(explode("/",$login_details['sign']));
                ...
                if($unlink_p){
                    echo '<script>alert("Signature Update Successfully Done.");window.location.assign("profile");</script>';
                }else{
                    echo '<script>alert("Signature Unlink Failed.");window.location.assign("profile");</script>';  
                }
            }else{
                echo '<script>alert("Signature Update Failed in DB.");window.location.assign("profile");</script>';     
            }
        }else{
            echo '<script>alert("Signature Upload Failed.");window.location.assign("profile");</script>';     
        }
    }else{
        echo '<script>alert("Please Select Signature.");window.location.assign("profile");</script>';
    }
}
        ...
        <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="card-header">
                <h3 class="card-title">Institute Profile Photo</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
             ...
             <div class="col-md-8">
                <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Institute Profile Details</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
           ...
           <div class="row">
               <div class="col-md-6">
                <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Institute Logo</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form name="form_3" method="post" enctype="multipart/form-data">
                <div class="card-body">
                
					    
        			     <div  style="text-align: center; margin-top:-15px;"><br>
                    	<img src="<?php echo $web_link.$login_details['ins_logo'] ?>" class="img3" id="logo-img-tag" hight="150" width="210">
                          </div>
                          
					          <br/>
						<div class="item form-group">
							<label for="last-name">Select Institute Logo<span class="required">*</span>
							</label>
							<div class="col-12 ">
								<input type="file" name="ins_logo" id="ins_logo" value="" class="form-control">
							</div>
						</div>
                ...
                <div class="card-footer">
                  <button type="submit" name="update_logo" class="btn btn-success">Update</button>
                </div>
              </form>
            </div>
            </div>
               <div class="col-md-6">
                <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Owner Signature</h3>
              </div>
              <form name="form_4" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  
					    
					   
        			     <div  style="text-align: center; margin-top:-15px;"><br>
                    	<img src="<?php echo $web_link.$login_details['sign'] ?>" class="img3" id="sign-img-tag" hight="150" width="210">
                          </div>
                         
					          <br/>
						<div class="item form-group">
							<label for="last-name">Select Signature<span class="required">*</span>
							</label>
							<div class="col-12 ">
								<input type="file" name="sign" id="signature" value="" class="form-control">
							</div>
						</div>
                ...
                <div class="card-footer">
                  <button type="submit" name="update_signature" class="btn btn-success">Update</button>
                </div>
              </form>
            </div>
            </div>
