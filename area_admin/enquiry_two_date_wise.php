    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
           ...
           $show="";
            ...
            if($show==1){
            $total_enquery=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end')"));
            $total_enquery_convert=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') and  status='CLOSE'"));
            $total_enquery_cancel=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') and status='CANCEL'"));
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Follow-up Enquiry Details for : <?php echo $date_show1 ; ?> to <?php echo $date_show2 ; ?>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                              ...
                                              $sql_d=mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') order by id desc");   
