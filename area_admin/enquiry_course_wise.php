           ...
           $show="";
            if(isset($_POST['submit'])){
                ...
                if(!$course_id==""){
                   ...
                   $course_details=mysqli_fetch_array(mysqli_query($con,"select * from course_details where id='$course_id'"));
                }else{
            ...
            $total_enquery=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session' and course_id='$course_id'"));
            $total_enquery_convert=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session' and course_id='$course_id' and  status='CLOSE'"));
            $total_enquery_cancel=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session' and course_id='$course_id' and status='CANCEL'"));
            ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <strong><h3 class="card-title">Follow-up Enquiry Details By Course Name : <?php echo $course_details['name'] ;?>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                              ...
                                              $sql_d=mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session' and course_id='$course_id' order by id desc");   
