        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Close Follow-up Enquiry Details</h1>
                        </div>
                                ...
                                <div class="card-body">
                                   <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 0;
                                        $sql_d = mysqli_query($con, "SELECT * FROM enquiry_details WHERE branch_id='$current_branch_id' AND status='CANCEL' AND session_id='$c_session' ORDER BY next_date DESC");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $course['name'] ?></td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#viewModal<?= $row['id'] ?>">
                                                        View
                                                    </button>
                                                </td>
                                                <td><span onclick="get_data_view(<?php echo $row['id'];?>)" style="cursor:pointer;color:blue;"><i class="fa fa-eye"></i> Details</span></td>
                                                <td>
                                                    <a target="_blank" href="enquiry_details?ids=<?= $row['id'] ?>" class="btn btn-sm btn-success" title="Add follow-up details">
                                                        Add
                                                    </a>
                                                </td>
                                            </tr>
