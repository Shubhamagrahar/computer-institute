                                           ...
                                           $course_details=mysqli_fetch_array(mysqli_query($con,"select * from course_details where id='$row[course_id]'"));
                                            ...
                                            <tr>
                                                ...
                                                <td><a target="_blank" href="<?php echo $row['link']; ?>"><?php echo $row['link']; ?></a></td>
                                                 <td>
                                                  <label class="switch">
                                                    <input type="checkbox" onchange="toggle_lms_status(this, <?php echo $row['id']; ?>, 'status', 'lms_live_class')" <?php echo ($row['status'] == 'SHOW') ? 'checked' : ''; ?>>
...
function confirmDocumentDelete(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href = `lms_live_class?delete=YES&id=${id}`;
    }
  });
}
    </script>
