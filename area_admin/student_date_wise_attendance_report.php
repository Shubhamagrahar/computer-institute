    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if(!$_SESSION['search_date']==""){
                ...
                $sql=mysqli_query($con,"select * from course_book where status='RUN' and session_id='$c_session'");
                while($row=mysqli_fetch_array($sql)){
                   $sql_check=mysqli_num_rows(mysqli_query($con,"select * from attendance_student where userid='$row[userid]' and date='$_SESSION[search_date]' and session_id='$c_session'"));
                    if(!$sql_check>0){ 
                     $sql_insert=mysqli_query($con,"insert into `attendance_student`(`userid`, `session_id` `date`, `create_by`) values('$row[userid]', '$c_session', '$_SESSION[search_date]', '$_SESSION[userid]')");
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $i=0;
                                            $sql_d=mysqli_query($con,"select * from attendance_student where date='$_SESSION[search_date]' and session_id='$c_session'");
