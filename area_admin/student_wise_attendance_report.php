                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label>Enter Registration Number:</label>
                             <input type="text" value="" required name="search_reg_no" class="form-control" placeholder="Please enter registration number.">
                        </div>
                        ...
                        if(isset($_POST['search'])){
                            $reg_no=VerifyData($_POST['search_reg_no']);
                            if(!$reg_no==""){
                            $sql=mysqli_query($con,"select * from user where reg_no='$reg_no'");
