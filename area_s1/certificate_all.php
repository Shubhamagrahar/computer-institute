                                         ...
                                         <?php
                                           ...
                                           $course_details=mysqli_fetch_array(mysqli_query($con,"select * from course_details where id='$row[course_id]'"));
                                            ...
                                            <tr>
                                               ...
                                               <td><a target="_blank" href="print_certificate?data_id=<?php echo $row['id'] ;?>"><span class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i> View</span></a></td>
                                               <td><a target="_blank" href="print_marksheet?data_id=<?php echo $row['id'] ;?>"><span class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i> View</span></a></td>
