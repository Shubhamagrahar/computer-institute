        ...
        <div class="col-md-12">
            ...
            <div class="card-header bg-secondary text-white">
                <div class="card-title">
                    <p style="font-size:20px;" class="mb-1">
                        Online Exam Report of: <?php echo $brand_short_code ." ". $test_series_id; ?>
                    </p>
                    ...
                    ?>
                    <p class="mb-0">
                        <strong>Total Questions:</strong> <?php echo number_format($total_question); ?> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <strong>Checked: </strong><?php echo number_format($total_question_checked); ?> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <strong>Correct: </strong><?php echo number_format($correct_q_count); ?>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <strong>Score: </strong><?php echo $correct_q_count." / ". $total_question; ?>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <strong>Passing Percentage: </strong><?php echo $pass_per ?>%&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <strong>Obtained Percentage: </strong><?php echo $obtained_percentage ?>%&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
