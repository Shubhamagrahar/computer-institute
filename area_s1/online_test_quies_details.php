...
<head>
  ...
  <title><?php echo "KKFP".$test_series_id; ?> Test Series Details  |  <?php echo $brand_name; ?></title>
    <!-- Favicons -->
        ...
        <div class="col-md-12">
             ...
             <div class="card-header">
                 <div class="card-title">
                     <p style="font-size:20px;">Test Series Report of : <?php echo "KKFP".$test_series_id; ?></p>
                     <?php 
             ...
             <div class="card-body">
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $row['question']; ?></p>
                   ...
                   <div class="col-md-3" <?php if($row['correct_ans']==$row['ans1']){ echo 'style="color:green;font-weight: 600;"'; } ?>>
                       &nbsp;&nbsp;&nbsp;&nbsp;<input <?php if($row['ans1']==$row['your_ans']){ echo "checked"; } ?> disabled type="radio" name="final_ans<?php echo $row['id']; ?>" value="ans1">&nbsp;&nbsp;<?php echo $row['ans1']; ?>
                   </div>
                   <div class="col-md-3" <?php if($row['correct_ans']==$row['ans2']){ echo 'style="color:green;font-weight: 600;"'; } ?>>
                       &nbsp;&nbsp;&nbsp;&nbsp;<input <?php if($row['ans2']==$row['your_ans']){ echo "checked"; } ?> disabled type="radio" name="final_ans<?php echo $row['id']; ?>" value="ans2">&nbsp;&nbsp;<?php echo $row['ans2']; ?>
                   </div>
                   <div class="col-md-3" <?php if($row['correct_ans']==$row['ans3']){ echo 'style="color:green;font-weight: 600;"'; } ?>>
                       &nbsp;&nbsp;&nbsp;&nbsp;<input <?php if($row['ans3']==$row['your_ans']){ echo "checked"; } ?> disabled type="radio" name="final_ans<?php echo $row['id']; ?>" value="ans3">&nbsp;&nbsp;<?php echo $row['ans3']; ?>
                   </div>
                   <div class="col-md-3" <?php if($row['correct_ans']==$row['ans4']){ echo 'style="color:green;font-weight: 600;"'; } ?>>
                       &nbsp;&nbsp;&nbsp;&nbsp;<input <?php if($row['ans4']==$row['your_ans']){ echo "checked"; } ?> disabled type="radio" name="final_ans<?php echo $row['id']; ?>" value="ans4">&nbsp;&nbsp;<?php echo $row['ans4']; ?>
                   </div>
               </div>
               <hr>
               <?php } ?>
