...
<head>
    <meta charset="utf-8">
    <title><?php echo $brand_name ?> | Marksheet Verification</title>
   ...
   <link rel="preconnect" href="https://fonts.googleapis.com">
    ...
    <style>
        ...
        .container-xxxl{
            ...
            /*background-image: url('img/background/gradient_background.webp');*/
...
<body>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Marksheet Verification</h1>
    ...
    <div class="container-xxxl py-5">
        ...
        <h2 class="animated-heading">Marksheet Verification</h2>
        <form>
            <div class="form-group">
                <label for="certificate_no">Certificate No./S.N.: <span style="color: red;">*</span></label>
