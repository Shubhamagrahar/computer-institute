                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_result = mysqli_query($con, "
                                                SELECT 
                                                    ota.id AS attempt_id,
                                                    ota.online_test_exam_id AS text_exam_id,
                                                    u.name AS user_name,
                                                    ...
                                                    ota.start_time,
                                                    ota.end_time,
                                                    otest.pass_mark_percent,
                                                    cd.name AS course_name
                                                FROM 
                                                    online_test_attempt ota
                                                LEFT JOIN 
                                                    user u ON u.id = ota.userid
                                                LEFT JOIN 
                                                    online_test_exam_details otest ON otest.id = ota.online_test_exam_id
                                                LEFT JOIN 
                                                    course_details cd ON cd.id = otest.course_id
                                                    WHERE 
                                                    ota.session_id = '$c_session'
                                                ORDER BY 
                                                    ota.id DESC
                                            ");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['test_level']; ?></td>
                                                <td><?php echo $row['start_time']; ?></td>
                                                <td><?php echo $row['end_time']; ?></td>
                                                <td><?php echo $row['pass_mark_percent']; ?>%</td>
                                                <td>
                                                    <a href="online_test_report?ids=<?php echo $row['text_exam_id']; ?>">View</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
