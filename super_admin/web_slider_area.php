...
if(isset($_POST['submit'])){
  ...
  $btn1_name= VerifyData($_POST['btn1_name']);
  $btn1_link= VerifyData($_POST['btn1_link']);
  $btn2_name= VerifyData($_POST['btn2_name']);
  $btn2_link= VerifyData($_POST['btn2_link']);
   $photo = $_FILES["upload_file1"]["name"];
     $photo2 = $_FILES["upload_file1"]["tmp_name"];
  
//   if(!$photo=="" && !$short_name=="" && !$short_about==""){
 if(!$photo==""){
       ...
       $extension12 = explode(".", $photo);
          ...
          if($extension1=="JPEG" or $extension1=="JPG" or $extension1=="PNG" or $extension1=="jpeg" or $extension1=="jpg" or $extension1=="png"){
            ...
            if($upload_photo){
          $insert=mysqli_query($con,"insert into `web_top_slider_area`(`con_hading`, `short_about`,  `btn1_name`, `btn1_link`, `btn2_name`, `btn2_link`, `img`) values('$short_name', '$short_about', '$btn1_name', '$btn1_link', '$btn2_name', '$btn2_link', '$photo_dr')");
          if($insert){
    ...
    if(!$id==""){
        ...
        if(mysqli_num_rows($sql)==1){
            ...
            if($unlink){
                ...
                if($delete){
                    echo '<script>alert("Slider deleted successfully done.");window.location.assign("web_slider_area")</script>';
                }else{
                   echo '<script>alert("Server Error 103.");window.location.assign("web_slider_area")</script>'; 
                }
            }else{
              ...
              <form method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea  class="form-control" id="short_name" name="short_name" value="" placeholder="Enter content heading."></textarea></textarea >
                  </div>
                  <!--<div class="form-group">-->
                  <!--  <label for="short_about">Content:</label>-->
                  <!--  <textarea  class="form-control" rows="5" id="short_about" name="short_about" value=""  placeholder="Enter content"></textarea>-->
                  ...
                  <div class="col-12" align="center">
                        ...
                        <div id="preview">
                            ...
                            <br>
                            <div class="form-group">
                    <label for="btn1_name"> Button-1 Name:</label>
                    <input type="text" class="form-control" id="btn1_name" name="btn1_name" value="" placeholder="Enter Button-1 Name.">
                  </div>
                  
                  <div class="form-group">
                    <label for="btn1_link"> Button-1 Link:</label>
                    <input type="text" class="form-control" id="btn1_link" name="btn1_link" value="" placeholder="Enter Button-1 Link.">
                  </div>
                  
                  
                  <div class="form-group">
                    <label for="btn2_name"> Button-2 Name:</label>
                    <input type="text" class="form-control" id="btn2_name" name="btn2_name" value="" placeholder="Enter Button-2 Name.">
                  </div>
                  
                  <div class="form-group">
                    <label for="btn2_link"> Button-2 Link:</label>
                    <input type="text" class="form-control" id="btn2_link" name="btn2_link" value="" placeholder="Enter Button-2 Link.">
                  </div>
                  ...
                  <p style="font-size:13px; color:red;"><strong>*</strong>Upload high-resolution images.<br><strong>*</strong>Upload image size 1920 x 500 for a better view.</p> 
                </div>
                <!-- /.card-body -->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['short_about']; ?></td>
                                                 <td><?php echo $row['btn1_name']; ?></td>
                                                 <td><?php echo $row['btn1_link']; ?></td>
                                                 <td><?php echo $row['btn2_name']; ?></td>
                                                 <td><?php echo $row['btn2_link']; ?></td>
