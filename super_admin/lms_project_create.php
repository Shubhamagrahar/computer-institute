                                           ...
                                           $course_details=mysqli_fetch_array(mysqli_query($con,"select * from course_details where id='$row[course_id]'"));
                                            ...
                                            <tr>
                                              ...
                                              <div class="modal fade" id="descModal<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="descModalLabel<?php echo $row['id']; ?>" aria-hidden="true">
                                                ...
                                                <td>
                                                  <label class="switch">
                                                    <input type="checkbox" onchange="toggle_lms_status(this, <?php echo $row['id']; ?>, 'status', 'lms_project_create')" <?php echo ($row['status'] == 'SHOW') ? 'checked' : ''; ?>>
                                                    <span class="slider round"></span>
                                                  </label>
                                                </td>
                                               <td>
                                                  <a title="Edit Project" href="#" onclick="confirmEditProject(<?php echo $row['id']; ?>)" style="color:blue;">
  ...
  function confirmEditProject(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = 'lms_project_create?edit=' + id;
      }
    });
  }
</script>
