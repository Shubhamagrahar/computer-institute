...
<html lang="en"
    ...
    <head>
        ...
        <title>LMS Document | <?php echo $brand_name; ?></title>
        <!-- Favicons -->
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="container page__container page-section pb-0">
                 ...
                 <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-50">
                            ...
                            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                                <h2 class="mb-0"> LMS Document Details</h2>

                                <ol class="breadcrumb p-0 m-0">
                                    <li class="breadcrumb-item"><a href="./"> LMS </a></li>

                                    <li class="breadcrumb-item active"> LMS Document </li>
                ...
                <div class="container page__container page-section">
                    ...
                    <div class="page-separator">
                        <div class="page-separator__text"> LMS Document Details</div>
                    </div>
                          ...
                          <table id="courseTable" class="display responsive nowrap table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                $i=0;
                                    ...
                                    $sql_video=mysqli_query($con,"select * from lms_document where course_id='$rows[course_id]' and status='SHOW' order by id desc");
                              ...
                              <tr>
                                ...
                                <td><a target="_blank" href="<?php echo $web_link.$row['file'];?>"><button class="btn btn-info"><i class="fa fa-eye"></i> View</button></a></td>
