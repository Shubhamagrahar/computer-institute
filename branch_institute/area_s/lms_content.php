...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <title>LMS Content | <?php echo $brand_name; ?></title>
        <!-- Favicons -->
...
[dir] .modal-backdrop {
    background-color: rgb(39 44 51 / 0%);
}
.modal-backdrop {
    position: absolute;
    top: 0;
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="container page__container page-section pb-0">
                 ...
                 <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-50">
                            ...
                            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                                <h2 class="mb-0"> LMS Content Details</h2>

                                <ol class="breadcrumb p-0 m-0">
                                    <li class="breadcrumb-item"><a href="./"> LMS </a></li>

                                    <li class="breadcrumb-item active"> LMS Content </li>
                ...
                <div class="container page__container page-section">
                    ...
                    <div class="page-separator">
                        <div class="page-separator__text"> LMS Content Details</div>
                    </div>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#desModal<?php echo $row['id']; ?>">
