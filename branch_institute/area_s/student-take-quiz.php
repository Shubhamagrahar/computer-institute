        ...
        <div class="mdk-drawer-layout js-mdk-drawer-layout"
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="navbar navbar-expand pr-0 navbar-light border-bottom-2"
                    ...
                    <a href="https://luma.humatheme.com/Demos/Compact_App_Layout/student-take-quiz"
                    ...
                    <div class="container page__container">
                        <nav class="course-nav">
                            ...
                            <a data-toggle="tooltip"
                               ...
                               href="student-take-lesson"><span class="material-icons">check_circle</span></a>
                            <a data-toggle="tooltip"
                               data-placement="bottom"
                    ...
                    <div class="container page__container">
                        ...
                        <div class="nav navbar-nav ml-sm-auto navbar-list__item">
                            <div class="nav-item d-flex flex-column flex-sm-row ml-sm-16pt">
                                <a href="student-quiz-result-details"
