...
<head>
    ...
    <title>Branch Apply Cancel List | <?php echo $brand_name; ?></title>
    <!-- Favicons -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>All Branch Apply Cancel List</h1>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Branch Apply Cancel Details</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                         <?php
                                            ...
                                            $sql_branch=mysqli_query($con,"select * from branch_application where status='CANCEL' order by id desc");
