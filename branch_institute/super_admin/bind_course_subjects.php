...
<!-- jQuery -->
  <script src="plugins/jquery/jquery.min.js"></script>
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: "You want to delete this bind subject data!",
        icon: 'question',
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 1) {
                        ...
                        Swal.fire(
                            'Deleted!',
                            'Bind subject data has been deleted.',
                            'success'
                        );
                    } else {
...
function create_data_sb() {
    ...
    let subject_id = $("#subject_id").val().trim();
    let subject_marks = $("#subject_marks").val().trim();
    ...
    if (course_id !== "") {
        if (subject_id !== "") {
            if (subject_marks !== "") {
                ...
                $("#Create_btn").hide();
                $("#Create_btn_span").show();

                $.ajax({
                    type: "GET",
                    url: "get_data",
                    data: {
                        create_subject_wise_course: course_id,
                        subject_id: subject_id,
                        subject_marks: subject_marks
                    },
                    success: function (data) {
                        $("#Create_btn").show();
                        $("#Create_btn_span").hide();
                        ...
                        if (data == 1) {
                            ...
                            Swal.fire(
                                'Success!',
                                'Subject bind successfully done.',
                                'success'
                            );
                ...
                Swal.fire('Error!', "Please enter max marks.", 'error');
            }
        } else {
