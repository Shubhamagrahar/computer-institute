...
<body class="hold-transition sidebar-mini layout-fixed">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#"
                                                       onclick="editConfirm(event, 'test_question_details?type_data=<?php echo $id; ?>&edit_id=<?php echo $sql_question_details['id']; ?>')" 
                                                       style="color:blue;">
                                                      <i class="fa fa-edit"></i> Edit
                                                    </a>
                                                    </td>
                                                <td><a href="#"
                                                       onclick="deleteConfirm(event, 'test_question_details?type_data=<?php echo $id; ?>&delete_id=<?php echo $row['id']; ?>')"
                                                       style="color:red;">
    ...
    <script>
  function editConfirm(event, url) {
