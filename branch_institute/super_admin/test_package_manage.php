                                                ...
                                                <td><a href="test_package_manage?edit=<?php echo $row['id']; ?>" onclick="return confirm('Are your sure for edit this package?')"><button class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button></a></td>
                                                 <td>
                                                  <label class="switch">
                                                    ...
                                                    <span class="slider round"><?php echo ($row['status'] == 'OPEN') ? 'YES' : 'NO'; ?></span>
                                                  </label>
                                                </td>
...
function toggle_permission(element, id, field) {
    ...
    // Revert checkbox until confirmation
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Set checkbox again after confirmation
            element.checked = isChecked;
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    const label = element.closest('.switch').querySelector('.slider');
                    label.textContent = newStatus === 'OPEN' ? 'YES' : 'NO';
                },
                error: function () {
                    element.checked = !isChecked;
