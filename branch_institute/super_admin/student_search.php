...
if(isset($_GET['reg_no'])){
    ...
    if(!$reg_no==""){
        ...
        if(mysqli_num_rows($check)==1){
          ...
          echo '<script>alert("Registration number not found.");window.location.assign("student_search");</script>';   
        }
    }else{
       echo '<script>alert("Please enter valid registration number.");window.location.assign("student_search");</script>'; 
    }
...
//           $user_details=mysqli_fetch_array(mysqli_query($con,"select * from user where id='$book_course_details[userid]'"));
//       }else{
...
<head>
  ...
  <title>Student Details |  <?php echo $brand_name; ?></title>
    <!-- Favicons -->
      ...
      <section class="content">
         <div class="container-fluid">
            ...
            <div class="card-header">
                <h3 class="card-title">Student Details Search By Registration Number</h3>
              </div>
                 <div class="card-body">
                  <div class="row">
					  <div class="col-md-3">
                       <label>Registration Number:</label>
                      <input type="text"  name="reg_no" required value="" class="form-control" placeholder="Enter Registration Number.">
  ...
  <?php 
   ...
   ?> 
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="row">
                      ...
                      <input type="text" required name="mother_name" onkeyup="update_user_details('mother_name',this.value,'<?php echo $user_details['id'] ;?>')" value="<?php echo $user_details['mother_name'] ;?>" class="form-control">
    ...
    <div class="d-flex align-items-center">
        <label class="mb-0 mr-2">Registration Number:</label>
        <input type="text" required name="reg_no" readonly 
               value="<?php echo $user_details['reg_no'] ;?>" 
              ...
              <!-- form start -->
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                      ...
                      <input type="text" name="mobile" onkeyup="update_user_details('mobile',this.value,'<?php echo $user_details['id'] ;?>')" value="<?php echo $user_details['mobile'] ;?>" class="form-control">
                  </div>
                   <div class="col-md-6">
                ...
                <select name="gender"  id="gender"  required  class="form-control" onchange="update_user_details('gender',this.value,'<?php echo $user_details['id'] ;?>')">
                  ...
                  <script>
                   ...
                   <div class="col-md-6">
                <label>State:</label>
                <select name="state"  id="state"  required  class="form-control" onchange="update_user_details('state_id',this.value,'<?php echo $user_details['id'] ;?>')">
                   <option value="">Select </option>
                    <?php
                  ...
                  <script>
                    $("#state").val('<?php echo $user_details['state_id'] ;?>');
                  
                </script>
                   <div class="col-md-6">
                      <label>Pin Code: </label>
                      <input type="number"  name="pin" id="pin" onchange="update_user_details('pin',this.value,'<?php echo $user_details['id'] ;?>')" required value="<?php echo $user_details['pin'] ;?>" class="form-control">
                  </div>
