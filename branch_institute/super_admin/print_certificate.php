  ...
  .print222{
    ...
    <div class="print111" style="width: fit-content !important; visibility: visible;">
                <div style="position:absolute;margin: 362px 0 0 170px; width: 770px; font-size: 30px; text-align:center;font-family: math;font-weight: 700;">
					...
					<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo $brand_link; ?>verify?certificate_no=<?php echo $certificate_no; ?>%26dob=<?php echo $result['dob']; ?>" style="position: absolute; margin-top: 400px;  margin-left: 908px; width: 104px;">		
					
					<img src="image/certificate.jpg" style="" class="print222" />
					</div>
		<script>
