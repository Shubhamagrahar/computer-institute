                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">LMS Live Class Details</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                         ...
                                         $course_details=mysqli_fetch_array(mysqli_query($con,"select * from course_details where id='$row[course_id]'"));
                                            ...
                                            <tr>
                                                ...
                                                <td><a target="_blank" href="<?php echo $row['link'];?>"><button class="btn btn-success"><i class="fa fa-video-camera"></i> Join</button></a></td>
