...
<head>
    <meta charset="utf-8">
    <title><?php echo $brand_name ?> | Administrative Staff</title>
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                <h1 class="display-3 text-white animated slideInDown">Administrative</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class=""><a class="text-white" href="./"> Home / </a></li>
                        <li class=""><a class="text-white" href="#">  Staff / </a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Administrative</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="animated-heading">Administrative Staff</h1>
            </div>
            <div class="row g-4">
                <?php
        		    $sql_teacher=mysqli_query($con,"select * from web_teching_admin_staff where role='administrative'");
