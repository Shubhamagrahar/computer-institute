...
if (isset($_GET['userid']) && isset($_GET['session_id'])) {
    ...
    $student_admission_details = mysqli_fetch_array(mysqli_query($con, "select * from course_book where userid='$userid' and status='RUN' and session_id='$student_session_id'"));
    $course_id = $student_admission_details['course_id'];
    $start_date = date('d-M-Y' , strtotime($student_admission_details['start_date']));
...
if ($row = mysqli_fetch_assoc($result)) {
    ...
    $trimmedAddress = $row['full_add'];
     $test = "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" . $brand_link . "verify-student?reg_no=" . $row['reg_no'] . "&dob=" . $row['dob'];
     error_log($test);
...
<style>
        * {
        ...
        .adm, .dob, .phone, .fname, .address, .course{
            display:flex;
            font-size: 10px;
...
/*Design-4*/
    ...
    <div class='id-card-2'>
        ...
        <div class='MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-1 css-tuxzvu studet'>
            ...
            <div class='MuiStack-root css-19m7kbw sec'>
                        ...
                        <!--</div>-->
                        <br>
                        <img alt='' width='65px' height='65px' style='border: 1px solid black; margin-left: 20px;' src='{$web_link}{$row['photo']}'>
     ...
     urlencode($brand_link . "verify-student?reg_no=" . $row['reg_no'] . "&dob=" . $row['dob']) . 
     "' style='position: absolute; margin-top: 75px; margin-left: -70px; width: 40px; border-radius: 0px;'> 
     
                <div class='full'>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-3 css-4xkoi8'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha bold'>Reg No. </p>
                        </div>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-9 css-14ybvol'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha'> : {$row['reg_no']}</p>
                        </div>
                    </div>
                    ...
                    <div class='full'>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-3 css-4xkoi8'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha bold'>Mobile </p>
                        </div>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-9 css-14ybvol'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha'> : {$row['mobile']}</p>
                        </div>
                    </div>
                    ...
                    <div class='full'>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-3 css-4xkoi8'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha bold'>COURSE </p>
                        </div>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-5.5 css-1tqxarj'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha'> :{$course_name}</p>
                        </div>
                   </div>
                    
                    <div class='full'>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-3 css-4xkoi8'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha bold' style=' width: 60px;'>ISSUE DATE </p>
                        </div>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-9 css-14ybvol'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha'> : $start_date</p>
                        </div>
                    </div>
    ...
    <div class='id-card-2'>
        <div class='id-header3' style='display:block; height:45px;'>
            
            <div class='scl-name2' style='padding-top: 5px;'>
                    <h1>$brand_name</h1>
                    <h2>$brand_add</h2>
            </div>
     ...
     "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" . 
     urlencode($brand_link . "verify-student?reg_no=" . $row['reg_no'] . "&dob=" . $row['dob']) . 
     "' style='position: absolute; margin-top: 90px; margin-left: -70px; width: 38px; border-radius: 0px;'>
                ...
                <div class='full'>
                    ...
                    <div class='full'>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-3 css-4xkoi8'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha bold' style=' width: 60px;'>COURSE </p>
                        </div>
                        <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-9 css-14ybvol'>
                            <p class='MuiTypography-root MuiTypography-body1 heading css-8va9ha'> : {$course_name}</p>
                        </div>
            ...
            <div class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-8 css-y4pdto'>
                ...
                <div class='full'>
                    ...
                    <div class='MuiStack-root css-19m7kbw sec'>
                        ...
                        <img alt='' width='75px' height='90px' style='border: 2px solid black; margin-top: 8px;' src='{$web_link}{$row['photo']}'>
                        <img src='" . 
                         "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" . 
                         urlencode($brand_link . "verify-student?reg_no=" . $row['reg_no'] . "&dob=" . $row['dob']) . 
                         "' style='position: absolute; margin-top: 105px; margin-left: -57px; width: 40px; border-radius: 0px;'>  
    ...
    <div class='id-card'>
        ...
        <div class='id-body'>
            ...
            <p class='session'>Session: $session_name</p>
            <h2>{$row['name']}</h2>
            <p>{$course_name}</p>
            <img src='" . 
     "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" . 
     urlencode($brand_link . "verify-student?reg_no=" . $row['reg_no'] . "&dob=" . $row['dob']) . 
     "' style='position: absolute; margin-top: 0px; margin-left: 50px; width: 40px; border-radius: 0px;'>  
            <div class='info'>
                <div class='adm'>
                    <div class='label'>Reg No.</div>
                    <div class='colon'> <strong>:</strong> </div>
                    <div class='content'>{$row['reg_no']}</div>
                </div>
                ...
                <div class='fname'>
                 ...
                 <div class='address'>
                    ...
                    <div class='colon'><strong>:</strong></div>
                    <div class='content' style='width: 145px; text-align: justify;'> $start_date </div>
                </div>
                
                <div class='address'>
                    <div class='label'>Address</div>
                    <div class='colon'><strong>:</strong></div>
                    <div class='content' style='width: 145px; text-align: justify;'>$trimmedAddress</div>
                </div>
...
<img src='" . 
     ...
     "' style='position: absolute; margin-top: 0px; margin-left: 50px; width: 40px; border-radius: 0px;'>           
        ...
        <div class='id-footer' style='margin-top:15px;'>
            $brand_add
        </div>
    </div>
</div>";}
...
<img src='" . 
     "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" . 
     urlencode($brand_link . "verify-student?reg_no=" . $row['reg_no'] . "&dob=" . $row['dob']) . 
     "' style='position: absolute; margin-top: 0px; margin-left: 50px; width: 40px; border-radius: 0px;'>              <div class='info'>
                <div class='adm'>
                    <div class='label'>Reg No.</div>
                    <div class='colon'> <strong>:</strong> </div>
                    <div class='content'>{$row['reg_no']}</div>
