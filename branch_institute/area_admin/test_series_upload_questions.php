    ...
    <div class="wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <!-- /.container-fluid -->
                        ...
                        <div class="col-md-12 mx-auto" style="text-align:end;"><a href="test_question_create"><button class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;Add Questions</button></a></div>
                                ...
                                <div class="col-md-6">
                                  <div class="card">
                                    <div class="card-header bg-info text-white">
                                      <h4 class="mb-0">Upload Test Questions CSV</h4>
                                    </div>
                                    <div class="card-body">
                                      <form id="csv_upload_form" enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex justify-content-between mt-4">
                                          ...
                                          <a href="download_sample.php" id="download_template" class="btn btn-success">Download Template</a>
                                        </div>
                                      </form>
                                    </div>
                                  </div>
      ...
      <div class="card">
        <div class="card-header bg-warning text-dark">
          <h5 class="mb-0">Available Test Series Types</h5>
        </div>
        <div class="card-body p-3">
          <table class="table table-bordered table-sm mb-0">
            ...
            <tbody>
              ...
              $query = mysqli_query($con, "SELECT id, name FROM test_series_type ORDER BY id ASC");
...
<script>
  ...
  <li style="margin-bottom: 12px;">Ensure that the <code>correct_ans</code> field contains only the column names like <code>ans_a</code>, <code>ans_b</code>, etc. — not the actual answer text.</li>
  <li style="margin-bottom: 12px;"><b>Make sure the <code>test_series_type_id</code> is valid</b> and matches one of the IDs listed on the page.</li>
    ...
    $("#download_template").on("click", function (e) {
      ...
      Swal.fire({
        ...
        html: `
          ...
          <p>In the <code>correct_ans</code> column, use the column names like <code>ans_a</code>, <code>ans_b</code>, etc.</p>
