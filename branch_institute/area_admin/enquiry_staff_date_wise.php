        ...
        <div class="content-wrapper">
                 ...
                 <div class="container-fluid">
                     ...
                     <div class="row">
                        <div class="form-group col-md-3">
                             ...
                             <input type="date" name="select_date_start" required class="form-control">
                        </div>
                        <div class="form-group col-md-3">
                             <label>Select end Date</label>
                             <input type="date" name="select_date_end" required class="form-control">
                        </div>
                        <div class="form-group col-md-3">
                             <label>Select staff</label>
                             <select name="create_by" required class="form-control">
           ...
           $show="";
            if(isset($_POST['submit'])){
                $select_date_start=VerifyData($_POST['select_date_start']);
                $select_date_end=VerifyData($_POST['select_date_end']);
                $create_by=VerifyData($_POST['create_by']);
                if(!$select_date_start=="" and !$select_date_end=="" and !$create_by==""){
                   $show=1;
                   $date_show1=date_format(date_create($select_date_start),"d-m-Y") ; 
                   $date_show2=date_format(date_create($select_date_end),"d-m-Y") ;
                   $staff_details=mysqli_fetch_array(mysqli_query($con,"select * from user where id='$create_by'"));
                }else{
            ...
            if($show==1){
            $total_enquery=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and create_by='$create_by' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end')"));
            $total_enquery_convert=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and create_by='$create_by' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') and  status='CLOSE'"));
            $total_enquery_cancel=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and create_by='$create_by' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') and status='CANCEL'"));
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Follow-up Enquiry Details for : <?php echo $date_show1 ; ?> to <?php echo $date_show2 ; ?> &nbsp; Staff Name : <?php echo $staff_details['name'] ;?>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                              ...
                                              $sql_d=mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session'  and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') and create_by='$create_by' order by id desc");   
