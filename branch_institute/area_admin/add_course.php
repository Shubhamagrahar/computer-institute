...
if(isset($_POST['Create'])){
    ...
    if(!$course_name=="" and !$duration=="" and !$fee=="" and !$content=="" and !$photo=="" and !$max_fee==""){
        ...
        if(!$check_name>0){
           $extension12 = explode(".", $photo);
            ...
            if($upload_photo){
                $insert=mysqli_query($con,"insert into `course_details`(`name`, `img`, `duration`, `max_fee`, `fee`, `des`) values('$course_name', '$photo_dr', '$duration', '$max_fee', '$fee', '$content')");
               if($insert){
...
if(isset($_GET['edit'])){
    ...
    if(!$id==""){
        ...
        if(mysqli_num_rows($course_details)>0){
         ...
         echo '<script>alert("Course not available.");window.location.assign("add_course");</script>';    
        }
    }else{
      echo '<script>alert("Somthing Went Wrong.");window.location.assign("add_course");</script>';   
    }
        ...
        // if(!$check_name>0){
           $extension12 = explode(".", $photo);
            ...
            if($upload_photo){
                ...
                $update=mysqli_query($con,"update course_details set name='$course_name', img='$photo_dr', duration='$duration', max_fee='$max_fee', fee='$fee', des='$content' where id='$id'");
               if($update){
                                ...
                                <form method="post" name="form_2" enctype="multipart/form-data">
                                    <div class="card-body ">
                                        <div class="row">
                                            ...
                                            <input type="text" class="form-control" required value="<?php echo $course_name ;?>" name="course_name" id="course_name">
                                            </div>
                                            <br>
                                        <div class="col-sm-6" align="center">
                                            <lable>Duration: </lable>
                                            <input type="text" class="form-control" required value="<?php echo $course_duration ;?>" name="duration" id="duration">
                                        </div>
                                        <br>
                                        <div class="col-sm-6" align="center">
                                            <lable>Maximum Fees: </lable>
                                            <input type="text" class="form-control" required value="<?php echo $course_max_fee ;?>" name="max_fee" id="fee">
                                        </div>
                                        <br>
                                        <div class="col-sm-6" align="center">
                                            <lable>Total Fees: </lable>
                                            <input type="text" class="form-control" required value="<?php echo $course_fee ;?>" name="fee" id="fee">
                                        </div>
                                        <br>
