                 ...
                 <div class="container-fluid">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="date" name="next_date" class="form-control" required value="">
                        </div>
                        <div class="form-group col-md-3">
                             <br>
           ...
           $show="";
            if(isset($_POST['submit'])){
                ...
                if(!$next_date==""){
                   ...
                   $data_show_next=date_format(date_create($next_date),"d-m-Y");
                }else{
            ...
            $total_enquery=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id = '$c_session' and next_date='$next_date'"));
            $total_enquery_convert=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id = '$c_session' and next_date='$next_date' and  status='CLOSE'"));
            $total_enquery_cancel=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id = '$c_session' and next_date='$next_date' and status='CANCEL'"));
            ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <strong><h3 class="card-title">Follow-up Enquiry Details By Follow-up Date : <?php echo $data_show_next ;?>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                              ...
                                              $sql_d=mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and session_id='$c_session' and next_date='$next_date' order by id desc");   
