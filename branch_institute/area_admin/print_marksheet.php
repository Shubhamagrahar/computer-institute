...
@media print {
  ...
  .print222{
	...
	<!--<div style="position: relative; width:715px; height:1021px;">-->
			...
			<div style="position: absolute; margin-top: 945px;  margin-left: 75px; ">
					<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo $brand_link; ?>verify?certificate_no=<?php echo $certificate_no; ?>%26dob=<?php echo $result['dob']; ?>" style="width: 95px;">	
					</div>
