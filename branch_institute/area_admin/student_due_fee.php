                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $i=0;
                                            $sql_d=mysqli_query($con,"select * from wallet where main_b<'0' and userid in (select userid from course_book where session_id = '$c_session') order by id desc");
                                            $test = "select * from wallet where main_b<'0' and userid in (select userid from course_book where session_id = '$c_session') order by id desc";
                                            ...
                                            $user_details=mysqli_fetch_array(mysqli_query($con,"select * from user where id='$row[userid]'"));
                                             $date=date_create($user_details['r_date']);
                                            ...
                                            <tr>
                                                ...
                                                <td><?php  echo $row['main_b'] ; ?></td>
                                               
                                                <td><a target="_blank" href="student_search?reg_no=<?php echo $user_details['reg_no'] ;?>&search=Search"><span class="btn btn-primary">Details</span></a></td>
                                            </tr>
