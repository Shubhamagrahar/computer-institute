...
if(isset($_GET['data_id'])){
    ...
    if(!$data_id==""){
       ...
       $sql=mysqli_query($con,"select * from student_certificate where certificate_no='$data_id' and status='VERIFY'");
...
<html>
	<head>
	    <title> Marksheet for <?php echo $student_details['name'];?>, Certificate no. <?php echo $enrollment_no;?></title>
    <!-- Favicon -->
...
/*}*/
	...
	<body>
	<div class="print222" style="width: fit-content !important; visibility: visible;">	
	<!--<div style="position: relative; width:715px; height:1021px;">-->
	   
						
					<div style="position:absolute;margin: 269px 0 0 79px;font-weight: bold; width: 560px; font-size: 19px; text-align:center; color: #E80E13;">
						<!--Course Name Title -->
						<?php echo $course_details['name']; ?>					
						</div>
							<div style="position:absolute; margin: 343px 0 0 160px; font-weight: bold; color: #000000; font-size: 14px;">
				<?php echo $certificate_no; ?>
				</div>
					<div style="position:absolute; margin: 344px 0 0 500px; font-weight: bold; color: #000000; font-size: 14px;">
						<?php echo $enrollment_no; ?>
					</div>
					<div style="position:absolute; margin: 847px 0 0 89px; font-weight: bold; color: #000000; font-size: 15px;">
					<?php echo $issue_date; ?>
					</div>
					<div style="position:absolute; margin: 364px 0 0 160px; font-weight: bold; color: #000000; font-size: 14px;">
					<?php echo $name;?>
						</div>
						<div style="position:absolute; margin: 384px 0 0 160px; font-weight: bold; color: #000000; font-size: 14px;">
					<?php echo $father_name;?>
						</div>
						<div style="position:absolute; margin: 404px 0 0 160px; font-weight: bold; color: #000000; font-size: 14px;">
					<?php 
					if($student_details['branch_id']>0){
					    echo $branch_details['name'];
					}else{
					    echo "Branch Not Assign.";
					}	?>
						</div>
				
					<div style="position:absolute; margin: 507px 0 0 41px; font-weight: bold; color: #000000; font-size: 14px;">
					<style>
						.subjectName{
							width:382px;
							float:left;
					...
					<div style="position:absolute; margin: 744px 0 0 527px; font-weight: bold; color: #000000; font-size: 15px; width:182px; line-height: 1.5;">
					...
					<div style="position:absolute; margin: 746px 0 0 309px; font-weight: bold; color: #000000; font-size: 15px;">
			<?php echo $result_grade; ?></div>
			<div style="position:absolute; margin: 745px 0 0 143px; font-weight: bold; color: #000000; font-size: 15px;">
			<?php echo $marks_per; ?>%</div>
					...
					<div style="position: absolute; margin-top: 885px;  margin-left: 70px; width: 72px; height: 72px; overflow: hidden; ">
					...
					<img src="super_admin/image/marksheet.jpg" style="" class="print222" />
