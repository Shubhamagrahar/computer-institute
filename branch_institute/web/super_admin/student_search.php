...
if(isset($_GET['search'])){
    ...
    if(!$mobile==""){
        ...
        if(mysqli_num_rows($check)==1){
          ...
          echo '<script>alert("Mobile number not registered.");window.location.assign("student_search");</script>';   
        }
    }else{
       echo '<script>alert("Please enter registered mobile number.");window.location.assign("student_search");</script>'; 
    }
      ...
      <section class="content">
         <div class="container-fluid">
            ...
            <div class="card-header">
                <h3 class="card-title">Student Details Search By Mobile Number</h3>
              </div>
                 <div class="card-body">
                  <div class="row">
					  <div class="col-md-3">
                       <label>Mobile Number:</label>
                      <input type="number"  name="mobile" required value="" class="form-control" placeholder="Enter Registered Mobile Number.">
