...
if($web_director_message['status']=="SHOW"){
    ?>
<a href="web_director_message?status=HIDE&id=<?php echo $web_director_message['id']; ?>" onclick="return confirm('Are you sure to hide the director message?')"><button class="btn btn-danger"><i class="fa fa-eye-slash"></i> Hide</button></a>  
  <?php
}
if($web_director_message['status']=="HIDE"){
    ?>
  <a href="web_director_message?status=SHOW&id=<?php echo $web_director_message['id']; ?>" onclick="return confirm('Are you sure to show the director message?')"><button class="btn btn-success"><i class="fa fa-eye"></i> Show</button></a>  
   <?php  } ?>
</div>
                                </div>
                                <!-- /.card-header -->
