                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $i +=1; ?></td>
                                                <td><img width="200px" src="<?php echo $web_link.$row['img']; ?>"></td>
                                                
                                                 <td><?php echo $row['name']; ?></td>
                                               
                                              
                                                <td><a href="gallery?delete=YES&id=<?php echo $row['id']; ?>" onclick="return confirm('Are your sure for delete this photo?')"><button class="btn btn-danger"> Delete</button></a></td>
                                            </tr>
