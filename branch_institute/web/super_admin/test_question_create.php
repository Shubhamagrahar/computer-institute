            ...
            <section class="content">
              ...
              <!-- form start -->
                ...
                <div class="row">
                    ...
                    <textarea type="text" class="form-control" required value="" name="test_question" id="test_question" onkeyup="update_question_data('test_question',this.value)" placeholder="Enter Test Question."><?php echo $current_question_details['test_question']; ?></textarea>
                    <input type="hidden" name="question_data" id="question_data" value="<?php echo $current_question_details['id']; ?>">
                    </div>
                     <div class="col-sm-3" >
                    <label>Option A : </label>
                    <input type="text" class="form-control" required onkeyup="update_question_data('ans_a',this.value)" value="<?php echo $current_question_details['ans_a']; ?>" name="ans_a" id="ans_a" placeholder="Enter Anser Option A.">
                    </div>
                    <div class="col-sm-3" >
                    <label> Option B : </label>
                    <input type="text" required class="form-control" onkeyup="update_question_data('ans_b',this.value)" value="<?php echo $current_question_details['ans_b']; ?>" name="ans_b" id="ans_b" placeholder="Enter Anser Option B.">
                    </div>
                    <div class="col-sm-3" >
                    <label>Option C :</label>
                    <input type="text" required class="form-control" onkeyup="update_question_data('ans_c',this.value)" value="<?php echo $current_question_details['ans_c']; ?>" name="ans_c" id="ans_c" placeholder="Enter Anser Option C.">
                    </div>
                    <div class="col-sm-3" >
                    <label> Option D :</label>
                    <input  required class="form-control" onkeyup="update_question_data('ans_d',this.value)" value="<?php echo $current_question_details['ans_d']; ?>" name="ans_d" id="ans_d" placeholder="Enter Anser Option D.">
                    </div>
                    <div class="col-sm-3" >
