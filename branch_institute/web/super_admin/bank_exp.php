    ...
    if(!$amt==""){
      if($login_wallet['main_b']>=$amt){
       ...
       if($update_wallet){
           ...
           $teransactionIntsert=mysqli_query($con,"insert into `super_admin_transaction`(`userid`, `des`, `debit`, `date`, `c_date`, `op_bal`, `cl_bal`, `by_userid`) values('$_SESSION[userid]', '$desciption', '$amt', '$t_date', '$c_date', '$op_bal', '$cl_bal', '$_SESSION[userid]')");
            ...
            <div class="col-md-6">
              ...
              <form method="post">
                <div class="card-body">
                  ...
                  <!--  <input type="text" class="form-control" id="mobile" readonly name="mobile" Value="<?php echo $login_details['short_name'] ;?>" placeholder="Enter Registered Mobile Number">-->
                  <!--  <span id="mathc1"></span>-->
                  <!--</div>-->
                  <div class="form-group">
