...
<head>
    <meta charset="utf-8">
    <title>Marksheet | <?php echo $brand_name; ?></title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Marksheet</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Marksheet</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="section-title bg-white text-center text-primary px-3">Marksheet</h1>
                <br><br>
            </div>
            ...
            <div class="col-md-12">
                       <div class="contact-part">
                            <div  style="margin-bottom: 30px;" align="center">
                                ...
                                <h3 style="margin-top: 5px;">Verify Marksheet </h3>
   ...
   <?php include 'footer.php'; ?>
    ...
    <script>
        function data_verify(val){
            if(!val==""){
                window.open('verify_marksheet?data_id='+val);
                $("#en_no").val("");
            }else{
