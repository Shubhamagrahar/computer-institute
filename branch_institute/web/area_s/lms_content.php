                ...
                <div class="container-fluid">
                    <div class="row">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                             ...
                                             $sql_content=mysqli_query($con,"select * from lms_content where course_id='$rows[course_id]' and status='SHOW' order by id desc");
					    ...
					    <p ><?php echo $row['content']; ?></p>
					     <div align="center">
					     <button  type="submit" name="hide_des" onclick="hide_des_function('des_div<?php echo $row['id'];?>','des_btn<?php echo $row['id'];?>')" class="btn btn-danger"><i class="fa fa-eye-slash"></i> View</button> 
					     </div>
					     
					   </div>
					   <div class="col-md-12" align="center" id="des_btn<?php echo $row['id'];?>" >
					    <button type="submit" name="show_des" class="btn btn-success" onclick="show_des_function('des_div<?php echo $row['id'];?>','des_btn<?php echo $row['id'];?>')"><i class="fa fa-eye"></i> Hide</button> 
					 </div></td>
