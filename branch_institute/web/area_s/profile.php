              ...
              <form method="post" name="form_2">
                ...
                <select name="gender"  id="gender"  required  class="form-control">
                  ...
                  <div class="col-md-6">
                      ...
                      <input type="number"   name="pin" id="pin"  required value="<?php echo $login_details['pin'] ;?>" class="form-control">
                  </div>
                  ...
                  <div class="col-md-6" align="center">
                      <br><br>
                      <strong>Your franchise name : TVS SOLUTION </strong>
