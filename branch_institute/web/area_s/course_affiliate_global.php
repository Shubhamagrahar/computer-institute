...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>Course Global Affiliate |  <?php echo $brand_name; ?></title>
    <!-- Favicons -->
  ...
  <style type="text/css">
    ...
    .affiliate_course_details_global{
    	background: #157daf !important;
    }
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Global affiliate details</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <?php 
                      $i=0;
                      $sql_aff=mysqli_query($con,"select * from user where bulk_aff_id='$_SESSION[userid]'");
