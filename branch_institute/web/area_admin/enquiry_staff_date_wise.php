                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                              ...
                                              $sql_d=mysqli_query($con,"select * from enquiry_details branch_id='$current_branch_id' and where create_by='$create_by' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') order by id desc");   
