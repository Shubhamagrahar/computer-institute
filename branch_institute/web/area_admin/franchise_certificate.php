...
<div style="width: 1022px;
    ...
    <div class="print111" style="width: fit-content !important; visibility: visible;">
                   ...
                   <div style="position:absolute;margin: 294px 0 0 332px; width: 344px; font-size: 20px;text-align:center; font-family: math; font-weight: 700;">
					
					<?php echo $owner_name;?>	</div>
					<div style="position:absolute;margin: 403px 0 0 284px; width: 438px; font-size: 20px;text-align:center; font-family: math; font-weight: 700;">
		...
		<div style="position: absolute;">
		    	<img class="thing" src="<?php echo $web_link.$result['photo'];?>" style="position: absolute;background:white; margin: 252px 0 0 771px;width: 79px;height: 99px;  border-radius: 8px; ">
		</div>
					
			<div style="position: absolute; margin-top: 360px;  margin-left: 774px; width: 70px; height: 70px; overflow: hidden; border: 1px solid black;">
						<img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=Name: <?php echo $owner_name;?>, ATC Name: <?php echo $name; ?>, ATC Code: <?php echo $brand_short_code."ATC".$branch_id; ?>, Address: <?php echo $full_address;?>" style="position: absolute; margin-top: -7px;  margin-left: -7px; width: 83px;">	
					</div>
