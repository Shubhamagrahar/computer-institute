...
if($popup_details['status']=="ACTIVE"){
    ?>
<a href="web_index_popup?status=DEACTIVE&id=<?php echo $popup_details['id']; ?>" onclick="return confirm('Are you sure to disable the home page popup?')"><button class="btn btn-danger">Popup Hide</button></a>  
  <?php
}
if($popup_details['status']=="DEACTIVE"){
    ?>
  <a href="web_index_popup?status=ACTIVE&id=<?php echo $popup_details['id']; ?>" onclick="return confirm('Are you sure to enable the home page popup?')"><button class="btn btn-success">PopUp Show</button></a>  
   <?php } ?>
</div>
                    </div>
                    <!-- /.container-fluid -->
                                ...
                                <form method="post" name="form_2">
                                    <div class="card-body ">
                                        <div class="row">
                                            ...
                                            <label>Hading: </label>
                                            <input type="text" name="hading" id="hading" value="<?php echo $popup_details['hading']; ?>" class="form-control" placeholder="Enter Name" >
