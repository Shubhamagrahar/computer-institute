...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
 ...
 <div class="input-group" style="background-color:white;">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
          <a class="nav-link" data-toggle="dropdown" style="margin-top: -13px;" href="#"><span><?php echo $login_details['name'];?></span>
          ...
          <span class="dropdown-item dropdown-header"><strong><?php echo $login_details['name'];?></strong></span>
          <div class="dropdown-divider"></div>
          <a href="profile" class="dropdown-item"><i class="fa fa-user mr-2"></i>Profile</a>
          <!--<div class="dropdown-divider"></div>-->
