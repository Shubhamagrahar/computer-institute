    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
           ...
           $show="";
            ...
            $total_enquery=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and next_date='$next_date'"));
            $total_enquery_convert=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and next_date='$next_date' and  status='CLOSE'"));
            $total_enquery_cancel=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and next_date='$next_date' and status='CANCEL'"));
            ?>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                              ...
                                              $sql_d=mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and next_date='$next_date' order by id desc");   
