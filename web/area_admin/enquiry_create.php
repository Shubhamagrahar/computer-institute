...
if(isset($_POST['submit'])){
   ...
   if(!$name=="" and !$guardian_name=="" and !$guardian_occupation=="" and !$category=="" and !$mobile1=="" and !$address1=="" and !$employment_status=="" and !$computer_literacy=="" and !$qualification=="" and !$education_stream=="" and !$know_about_it=="" and !$handbill=="" and !$career_objective=="" and !$course_id=="" and !$enquiry_date=="" and !$batch_id=="" and !$next_date==""){
     ...
     if(!$check_mobile>0){
      ...
      $insert=mysqli_query($con,"insert into `enquiry_details`(`branch_id`, `create_by`, `name`, `guardian_name`, `guardian_relation`, `guardian_occupation`, `category`, `mobile1`, `mobile2`, `email`, `address1`, `employment_status`, `computer_literacy`, `qualification`, `education_stream`, `know_about_it`, `handbill`, `institute_student`, `institute_friends`, `institute_other`, `career_objective`, `course_id`, `enquiry_date`, `batch_id`, `next_date`, `enquiry_note`) values('$current_branch_id', '$_SESSION[userid]', '$name', '$guardian_name', '$guardian_relation', '$guardian_occupation', '$category', '$mobile1', '$mobile2', '$email', '$address1', '$employment_status', '$computer_literacy', '$qualification', '$education_stream', '$know_about_it', '$handbill', '$institute_student', '$institute_friends', '$institute_other', '$career_objective', '$course_id', '$enquiry_date', '$batch_id', '$next_date', '$enquiry_note')") ; 
            ...
            <div class="col-md-12">
              ...
              <form method="post">
                ...
                <div class="card-footer">
                  <button type="submit" id="submit_btn" name="submit" class="btn btn-primary">Create</button>
                </div>
              </form>
            </div>
            </div>
