                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <h4 class="card-title">Enquiry Create By : <?php echo $staff_details['name']; ?></h3>
                                        </div>
                                        <div class="col-md-3">
                                            <h4 class="card-title">Name : <?php echo $enquiry_details['name']; ?></h3>
                                        </div>
                                        <div class="col-md-3">
                                            <h4 class="card-title">Mobile 1 : <?php echo $enquiry_details['mobile1']; ?></h3>
                                        </div>
                                        <div class="col-md-3">
                                            <h4 class="card-title">Mobile 2 : <?php echo $enquiry_details['mobile2']; ?></h3>
                                        </div>
                                        <hr>
                                        <div class="col-md-4">
                                            <h4 class="card-title">Course Name : <?php echo $course_details['name']; ?></h3>
                                        </div>
                                        <div class="col-md-4">
                                            <h4 class="card-title">Batch Name : <?php echo $batch_details['batch_name']; ?></h3>
                                        </div>
                                        <div class="col-md-4">
                                            <h4 class="card-title">Next Date : <?php 
