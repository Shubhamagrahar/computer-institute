                    ...
                    <div class="row">
                        ...
                        <script>
                            ...
                            function by_course(val){
                                var url="enroll_complete?course_id="+val;
                                window.location.assign(url);
                            }
                            
                            function by_batch(val){
                                var url="enroll_complete?batch_id="+val;
                                window.location.assign(url);
                            }
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if($get_batch_id>0){
                                               $sql_d=mysqli_query($con,"select * from course_book where status='CLOSE' and batch_id='$_GET[batch_id]'");
                                            }
                                            
                                            if($get_course_id>0){
                                              $sql_d=mysqli_query($con,"select * from course_book where course_id='$_GET[course_id]' and  status='CLOSE'");  
                                            }
                                            }else{
                                              $sql_d=mysqli_query($con,"select * from course_book where status='CLOSE'");   
                                            }
