                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                              ...
                                              $sql_d=mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and status='CANCEL' order by next_date desc");   
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <a  target="_blank" title="Add follow-up details" href="enquiry_details?ids=<?php echo $row['id'] ; ?>" style="cursor:pointer;color:blue;"><i class="fa fa-plus"></i> Add</a>&nbsp;&nbsp;&nbsp;<br>
                                                   ...
                                                   <!--<a onclick="return confirm('Are you sure for cancel follow-up.')" title="Cancel follow-up this details" href="enquiry_running?cancel_ids=<?php echo $row['id'] ; ?>" style="cursor:pointer;color:red;"><i class="fa fa-trash"></i> Cancel</a>-->
                                                </td>
