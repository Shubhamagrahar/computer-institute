...
if(isset($_GET['data_id'])){
    ...
    if(!$data_id==""){
      ...
      $sql=mysqli_query($con,"select * from user where type='2' and id='$data_id'");
      if(mysqli_num_rows($sql)==1){
          ...
          $staff_details=mysqli_fetch_array(mysqli_query($con,"select * from staff_details where userid='$result[id]'"));
...
<html>
	...
	<div style="position: relative; width:715px; height:1021px;">
					...
					<div style="position:absolute; margin: 186px 0 0 3px; font-weight: bold; color: #ffffff; font-size: 14px;min-width: 157px; max-width: 157px; width: 157px;text-transform: capitalize;">
		<?php echo $name; ?>
						</div>
						<div style="position:absolute; margin: 217px 0 0 89px; font-weight: bold;width: 143px; color: #ffffff;text-align: center; font-size: 14px;">
					<?php echo $staff_details['designation'];?>
						</div>
				...
				<img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?php echo $name; ?>/CC<?php echo $id; ?>&size=110x110" style="position: absolute; margin-top: -8px;  margin-left: -6px; width: 67px;">	
					</div>
