                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $i=0;
                                            $sql_d=mysqli_query($con,"select * from user where branch_id='$_SESSION[userid]' and type='3' order by id desc");
                                           ...
                                           <?php   }
                                              ...
                                              <?php 
                                                ...
                                                <td><a target="_blank" href="student_search?mobile=<?php echo $row['mobile'] ;?>&search=Search"><span class="btn btn-primary">Details</span></a></td>
                                            </tr>
