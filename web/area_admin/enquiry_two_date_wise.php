    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
           ...
           $show="";
            ...
            if($show==1){
            $total_enquery=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end')"));
            $total_enquery_convert=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') and  status='CLOSE'"));
            $total_enquery_cancel=mysqli_num_rows(mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') and status='CANCEL'"));
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=0;
                                              ...
                                              $sql_d=mysqli_query($con,"select * from enquiry_details where branch_id='$current_branch_id' and (enquiry_date>='$select_date_start' and enquiry_date<='$select_date_end') order by id desc");   
