...
if(isset($_GET['data_id'])){
    ...
    if(!$data_id==""){
      ...
      $sql=mysqli_query($con,"select * from student_certificate where certificate_no='$data_id'");
...
<html>
	<head>
	    <title> Certificate for <?php echo $name;?>-<?php echo $enrollment_no;?></title>
	     <!-- Favicons -->
...
/*}*/
    ...
    <div class="print222" style="width: fit-content !important; visibility: visible;">
					...
					<div style="position:absolute;margin: 329px 0 0 200px; width: 620px; font-size: 30px; text-align:center;  font-family: math">
					<?php echo $name;?>
					</div>
						<?php 
                        $max_mark=0;
                       ...
                       ?>
						...
						?>
					<div style="position:absolute;margin: 362px 0 0 257px;width: 526px; font-size: 20px; text-align:justify; ">
				...
				<span class="orange"><?php echo $father_name;?></span> On Successful Completion of <span class="orange"><?php echo $course_details['name']; ?></span> Condacted From <span class="orange"><?php echo $start_date; ?></span> to <span class="orange"><?php echo $complete_date; ?></span> in the <span class="orange" id="marksheet_grade"></span> grade from our training center <span class="orange" >
					...
					if($student_details['branch_id']>0){
					    ...
					    echo "Student not registeres or Branch Not Assign.";
							...
							<div style="position:absolute; margin: 206px 0 0 60px; font-size: 16px;font-weight: 600;">
				Certificate No.: <?php echo $certificate_no ; ?>	
						</div>
							<div style="position:absolute; margin: 227px 0 0 60px; font-size: 16px;font-weight: 600;">
				Enrollment No.: <?php echo $enrollment_no; ?> 
						</div>
						
							<div style="position:absolute; margin: 499px 0 0 272px; font-size: 16px;font-weight: 600;">
					Issue Date: <?php echo $issue_date; ?>	
						</div>
					
						<img class="thing" src="<?php echo $web_link.$result['photo']; ?>" style="position: absolute;background:white; margin: 189px 0 0 827px;width: 124px;height: 144px;   ">
					
				<img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?php echo $brand_link; ?>verify_certificate?data_id=<?php echo $certificate_no; ?>" style="position: absolute; margin-top: 374px;  margin-left: 862px; width: 104px;">	
