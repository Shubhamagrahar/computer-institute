...
<head>
    <meta charset="utf-8">
    <title><?php echo $brand_name ?> | Other Links</title>
...
<body>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Other Link</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class=""><a class="text-white" href="./"> Home / </a></li>
                            <li class=""><a class="text-white" href="#">  Student / </a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Other Link</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <h2 class="animated-heading">Other Links</h2>
    <div class="table">
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td>Website Link</td>
                <!--<td data-label="Link"><a href="<?php echo $brand_link?>"></a>Click Here</td>-->
                <td> <a href="<?php echo $brand_link?>" target="_blank">Click Here</a></td>
            </tr>
        </tbody>
    </table>
    </div>
